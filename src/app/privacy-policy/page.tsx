      ...
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div className="aria-font">
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            or (469) 379-2789 to exercise any of these rights; we will respond within the time
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            <strong>We do not sell or share your personal information.</strong> Restored Radiance
            Foundation does not sell personal information, and does not share it for cross-context
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            or (469) 379-2789. We will verify your request using information associated with your
